        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col lg:flex-row relative z-10 min-h-[600px]">
                ...
                <div className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                    <h1 className="text-3xl font-bold text-slate-900 mb-8">Sign In</h1>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-slate-500 gap-4 mt-8">
                            <Link href="/forgot-password" className="hover:text-[#1234A6] transition-colors">
                                Forget Password?
                            </Link>
                            <div className="flex items-center gap-1">
                                <span>Don't have an account?</span>
                                <Link href="/signup" className="text-[#3B60FF] hover:text-[#1234A6] font-medium transition-colors">
                                    Sign Up
                                </Link>
                            </div>
                        </div>
